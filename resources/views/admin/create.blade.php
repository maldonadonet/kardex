    ...
    <div class="col-xs-6 col-md-6 col-sm-12">
        <div class="card">
            <div class="card-header">
                <strong>Registro de usuarios</strong> <small> Sistema Administrativo</small>
            </div>
            ...
            <div class="card-body card-block">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" name="name" placeholder="Ingresa Nombre completo">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" type="email" name="email" placeholder="Ingrese correo institucional">
                    </div>
                </div>
                <div class="form-group">
